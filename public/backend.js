...
const httpBackend = {
  ...
  invoice: (usd, method, testnet, inviteCode) => jsonCall("POST", "/api/invoice", { usd, method, testnet: !!testnet, inviteCode: inviteCode || "" }),
...
const tauriBackend = (invoke) => ({
  ...
  invoice: (usd, method, testnet, inviteCode) => invoke("invoice", { usd, method, testnet: !!testnet, inviteCode: inviteCode || "" }),
...
export const Backend = {
  ...
  invoice: (usd, method, testnet, inviteCode) => pick("invoice", usd, method, testnet, inviteCode),
