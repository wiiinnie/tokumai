...
const httpBackend = {
  ...
  invoice: (usd, method, testnet) => jsonCall("POST", "/api/invoice", { usd, method, testnet: !!testnet }),
...
const tauriBackend = (invoke) => ({
  ...
  invoice: (usd, method, testnet) => invoke("invoice", { usd, method, testnet: !!testnet }),
...
export const Backend = {
  ...
  invoice: (usd, method, testnet) => pick("invoice", usd, method, testnet),
