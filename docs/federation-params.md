...
|---|---|---|
| `TOKU_PER_USD` | `100_000` | existing peg: 10 USD = 1,000,000 TOKU |
| `COIN_TOKU` | `1_000` | 1 ecash coin = 1000 TOKU = **$0.01** (one cent). Coarse on purpose: compact-ecash carries one serial PER coin, so fine coins → huge proofs. |
| ticketbook size `L` | `tier_scrai / COIN_TOKU` | e.g. $10 → 1000 coins, $5 → 500, $20 → 2000, $50 → 5000. |
